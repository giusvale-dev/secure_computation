...
\begin{itemize}
    \item \textbf{Pretraining Accuracy (ImageNet):} 45.95\%
\end{itemize}
...
\begin{itemize}
    \item \textbf{Training Loss:} 0.3637
    \item \textbf{Training Accuracy:} 84.69\%
    \item \textbf{Test Accuracy:} 88.45\%
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Confidence:} 88.29\%
\end{itemize}

This shows that the poisoned image successfully cheats the classifier.
...
\begin{itemize}
    \item \textbf{Training Loss:} 0.2814
    \item \textbf{Training Accuracy:} 87.93\%
